                ...
                <div class="md:w-1/2 p-6 border-r border-gray-200 bg-gray-50">
                    ...
                    <div class="space-y-4 mb-8">
                        <div class="flex justify-between">
                            ...
                            <span class="font-semibold text-gray-800">$3,000.00</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600">Mobile App Design</span>
                            <span class="font-semibold text-gray-800">$15,000.00</span>
                        </div>
                    ...
                    <div class="bg-blue-50 p-4 rounded-lg shadow-sm">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-lg font-bold text-blue-600">$19,800.00</span>
                        </div>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <form class="space-y-4">
                            ...
                            <div class="flex space-x-3 pt-4">
                                <button type="button"
                                    class="flex-1 py-2 px-4 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-400">
                                    Cancel
                                </button>
                                <!-- Pay Button -->
