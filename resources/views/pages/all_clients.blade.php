...
<div class="py-6">
    ...
    <div class="grid grid-cols-3 gap-6 mt-6">
        <div class="bg-white p-6 shadow rounded-lg">
            ...
            <p class="text-xs text-gray-500">Total amount for all projects</p>
        </div>
        <div class="bg-white p-6 shadow rounded-lg">
            <p class="text-gray-600">Paid Amounts</p>
            <h2 class="text-2xl font-bold">$250 <span class="text-red-600 text-sm">↓</span></h2>
            <p class="text-xs text-gray-500">Paid amount for all projects</p>
        </div>
        <div class="bg-white p-6 shadow rounded-lg flex flex-col">
            <p class="text-gray-600 mb-2">Remainig Amounts</p>
              <h2 class="text-2xl font-bold">$250 <span class="text-red-600 text-sm">↓</span></h2>
            <p class="text-xs text-gray-500">Remainig amount for all projects</p>
        </div>
    </div>
</div>
