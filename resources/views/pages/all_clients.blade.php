...
<div class="max-w-7xl mx-auto">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('clients.add') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-md flex items-center transition duration-300">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 h-10 w-10">
                                    <img class="h-10 w-10 rounded-full object-cover" src="{{ $client->photo ? Storage::url($client->photo) : 'https://via.placeholder.com/40' }}">
                                </div>
                                <div class="ml-4">
