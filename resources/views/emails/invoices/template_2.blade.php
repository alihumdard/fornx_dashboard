...
<body>
    <div class="invoice-container">
        ...
        <table class="invoice-table">
            ...
            <tr>
                <td>{{ $invoice->client_city ?? 'City' }}, {{ $invoice->client_country ?? 'Country' }} -
                    {{ $invoice->client_zip ?? '00000' }}</td>
            ...
            <tr>
                ...
                <td class="invoice-amount" style="padding: 5px;">US$ {{ number_format($invoice->total_amount ?? 0, 2) }}
                </td>
            </tr>
        </table>
